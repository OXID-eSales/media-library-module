...
+function ($) {
    ...
    Overlay.prototype.loadOverlay = function () {
        ...
        var overlay = '<div class="dd-backend-overlay">' + '<div class="dd-overlay-backdrop"></div>' + '<div class="dd-overlay-dialog">' + '  <div class="dd-overlay-dialog-header">' + '    ' + ddh.translate('DD_MEDIA_DIALOG') + '    <a href="javascript:void(null);" class="dd-overlay-dialog-close">&times;</a>' + '  </div>' + '  <div class="dd-overlay-dialog-body">' + '    <iframe src="" id="overlayFrame" frameborder="0" style="width: 100%; height: 100%;"></iframe>' + '  </div>' + '  <div class="dd-overlay-dialog-footer">' + '    <button type="button" class="dd-overlay-dialog-button dd-overlay-dialog-cancel">' + ddh.translate('DD_CANCEL') + '</button>' + '  </div>' + '</div>';
